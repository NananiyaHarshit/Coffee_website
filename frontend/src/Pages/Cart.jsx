  ...
  return (
    <div className="bg-text w-full min-h-screen">
      ...
      <div className="w-full flex flex-col lg:flex-row gap-5 lg:gap-8 items-start py-6 px-4 sm:px-8 lg:px-20">
        ...
        >
          {cart.map((item) => {
            return (
              <div
                key={item.details.id}
                className="bg-button/30 inset-ring-4 inset-ring-background/30 rounded-md flex w-full gap-2 sm:gap-5 px-2"
              >
                ...
                <div className="flex gap-2 sm:gap-5 w-full min-w-0 items-center">
                  ...
                  <div className="flex flex-col justify-between items-start py-3 sm:py-5 min-w-0 flex-1">
                    ...
                    <div className="w-full flex justify-start sm:justify-end items-center mt-2">
                      ...
                      <button
                        onClick={() =>
                          removeCartItem(item.details.id)
                        }
                        className="bg-red-700 text-text px-4 sm:px-8 py-1 rounded-md text-xs sm:text-sm whitespace-nowrap"
                      >
                        Remove item
                      </button>
                ...
                <div className="flex flex-col justify-between items-center py-3 sm:py-5 shrink-0">
                  ...
                  {/* Plus */}
                  <button
                    className="w-7 h-7 sm:w-8 sm:h-8 bg-background text-center rounded-md flex items-center justify-center text-text"
                    onClick={() =>
                      updateQuantity(
                        item.details.id,
                        1
        ...
        {/* Order Summary */}
        <div
          className="bg-button/30 w-full lg:w-[30%] min-h-87.5 lg:h-[60vh] rounded-lg p-4 sm:p-5 flex flex-col justify-center items-center gap-5 inset-ring-4 inset-ring-background/30"
        >
          ...
          <div className="w-full flex flex-col justify-between py-5 items-center rounded-md">
            ...
            <div className="w-full flex justify-center items-center mt-3">
              ...
              <button className="w-full sm:w-1/2 py-2 bg-background text-text font-semibold rounded-md">
                Checkout Now
              </button>
